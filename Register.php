...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
      <title>RejuveNate: Register</title>
                  ...
                  <form class="appointment-form" action="registration.php" method="post">
                    <div class="row">
                      <div class="col-md-6 col-sm-6">
                        ...
                        <input type="text" class="wp-form-control wpcf7-text" placeholder="First name" name="fname" required pattern="[A-Za-z-0-9]+"><input type="text" class="wp-form-control wpcf7-text" placeholder="Last name" name="lname" required pattern="[A-Za-z-0-9]+">
                      </div>                           
                    </div>
                    <div class="row">
                      <div class="col-md-6 col-sm-6">
                        <label class="control-label">Your Email <span class="required">*</span></label>
                        <input type="email" class="wp-form-control wpcf7-email" placeholder="Email address" name="mail" pattern= "[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>  
                      </div>
							      </div>
                    <div class="row">
                      <div class="col-md-6 col-sm-6">
                        <label class="control-label">Your Birth <span class="required">*</span></label>
                        <input type="date" class="wp-form-control wpcf7-text" placeholder="dd/mm/yy" max="<?php echo date("Y-m-d"); ?>" name="dob" required>
                      </div>
                    </div>
                    <div class="row">
                    <div class="col-md-6 col-sm-6">
                      <label class="control-label">Select Gender <span class="required">*</span></label>
                      <select class="wp-form-control wpcf7-select" name="gnd" required>
                        <option val="Undefined">Select Gender</option>
                    ...
                    <div class="row">
                      <div class="col-md-6 col-sm-6">
                        ...
                        <input type="text" class="wp-form-control wpcf7-text" placeholder="Your Address" name="addr" required>
                      </div>                           
                    </div>
                    <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <label class="control-label">Your Phone <span class="required">*</span></label>
                        <input type="number" class="wp-form-control wpcf7-text" placeholder="Phone No" name="phno" pattern="[0-9]{11}" required>  
                      </div>         
                    </div>
                    <div class="row">
                      <div class="col-md-6 col-sm-6">
